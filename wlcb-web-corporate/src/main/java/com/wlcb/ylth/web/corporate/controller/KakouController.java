...
import com.wlcb.ylth.module.common.service.corporate.RecordService;
...
public class KakouController {
    ...
    public ResponseData add(TblCsrrgCorporateKakou kakou, HttpServletRequest request, HttpServletResponse response){
        ...
        TblCsrrgCorporateKakou corporateKakou = corporateService.selectKakouByCorporateId(kakou.getCorporateId());
        if (corporateKakou != null){
            return ReturnJsonUtil.printJson(300,"该企业已绑定卡口，不可重复申请",false);
        }
