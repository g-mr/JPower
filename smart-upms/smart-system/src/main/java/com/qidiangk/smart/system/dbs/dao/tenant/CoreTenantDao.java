package com.qidiangk.smart.system.dbs.dao.tenant;
...
import static com.qidiangk.smart.system.dbs.entity.tenant.table.CoreTenantTableDef.CORE_TENANT;
...
public class CoreTenantDao extends JpowerServiceImpl<CoreTenantMapper, CoreTenant> {
	 ...
	 * @return java.util.List<com.qidiangk.smart.system.vo.SelectVO> 列表
	 **/
