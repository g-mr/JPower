...
- **实时数据大屏** — 今日通话总量、在线坐席数、AI 处理量、平均通话时长、接通率等核心指标一目了然
- **通话趋势分析** — 按小时 / 按周维度展示 AI 通话与人工通话趋势对比
- **AI vs 人工占比分析** — 可视化 AI 独立处理、AI 辅助、人工处理三类通话占比
- **坐席效能排名** — 实时统计坐席接听量排名，辅助绩效管理
- **通话类型分布** — 呼入 / 呼出 / 内部通话 / 网页外呼等多维度饼图分析
