    ...
    public void info(final OperateInfo controllerLog, JoinPoint joinPoint, Object rvt, Exception e){
        ...
        try {
            ...
            if (controllerLog.isSaveLog()){
                ...
                operLog.setStatus(top.jpower.jpower.module.base.annotation.OperateLog.BusinessStatus.SUCCESS.ordinal());

                if (Fc.notNull(e)){
                    operLog.setStatus(top.jpower.jpower.module.base.annotation.OperateLog.BusinessStatus.FAIL.ordinal());
                ...
                // 设置action动作
                if (EnumUtil.equalsIgnoreCase(controllerLog.businessType(), top.jpower.jpower.module.base.annotation.OperateLog.BusinessType.OTHER.name())
