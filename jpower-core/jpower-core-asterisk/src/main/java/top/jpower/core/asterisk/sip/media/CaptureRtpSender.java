...
package top.jpower.core.asterisk.sip.media;

import top.jpower.core.asterisk.sip.Logger;
import top.jpower.core.asterisk.sip.rtp.RFC3551;
import top.jpower.core.asterisk.sip.rtp.RtpSession;
...
public class CaptureRtpSender {
    ...
    public CaptureRtpSender(RtpSession rtpSession, SoundSource soundSource,
        ...
        switch (codec.getPayloadType()) {
            case RFC3551.PAYLOAD_TYPE_PCMU -> encoder = new PcmuEncoder(rawDataInput, encodedDataOutput,
                    mediaDebug, logger, peersHome, latch);
            case RFC3551.PAYLOAD_TYPE_PCMA -> encoder = new PcmaEncoder(rawDataInput, encodedDataOutput,
                    mediaDebug, logger, peersHome, latch);
            default -> {
