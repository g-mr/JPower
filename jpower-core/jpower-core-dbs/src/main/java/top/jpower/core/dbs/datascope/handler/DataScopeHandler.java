...
public class DataScopeHandler implements DataPermissionHandler {
    ...
    private DataScope findDataScope(String mapperId) {
        ...
        try {
            ...
            top.jpower.core.dbs.datascope.annotation.DataScope dataScopeAnnotation = AnnotationUtil.getAnnotation(ReflectUtil.getMethodByName(Class.forName(className),methodName), top.jpower.core.dbs.datascope.annotation.DataScope.class);
