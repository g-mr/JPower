...
public class AppConstant implements LogConstant, ClientNameConstant {
    ...
    /** 项目名称 **/
    public static final String JPOWER = "smart";
    ...
    /** 呼叫中心模块名称 **/
    public static final String JPOWER_SMART_ASTER = JPOWER+"-aster";
    /** MAXKB模块名称 **/
    public static final String JPOWER_SMART_MAXKB = JPOWER+"-maxkb";
    ...
    static {
        ...
        map.put("com.qidiangk.smart.system", JPOWER_SYSTEM);
        map.put("com.qidiangk.smart.user", JPOWER_USER);
        map.put("com.qidiangk.smart.resource", JPOWER_RESOURCE);
        map.put("com.qidiangk.smart.log", JPOWER_LOG);
        map.put("com.qidiangk.smart.auth", JPOWER_AUTH);
        map.put("com.qidiangk.smart.aster", JPOWER_SMART_ASTER);
        map.put("com.qidiangk.smart.maxkb", JPOWER_SMART_MAXKB);
