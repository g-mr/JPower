package top.jpower.jpower.service.city;
...
public interface CoreCityService extends BaseService<TbCoreCity> {
     ...
     * @return java.util.List<top.jpower.jpower.module.dbs.entity.core.city.TbCoreCity>
     * @param coreCity
     */
     ...
     * @param cityCode
     * @return top.jpower.jpower.module.dbs.entity.core.city.TbCoreCity
     */
