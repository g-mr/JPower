...
import com.wlcb.jpower.module.common.swagger.SwaggerConfigUtil;
...
public class Knife4jController {
    ...
    private Swagger extend(Swagger swagger) {
        ...
        while (it.hasNext()) {
            ...
            if (key.contains("ResponseData")) {
                if (!Fc.equals(key,"ResponseData")){
                    Map<String, Property> props = model.getProperties();
                    Property dataProp = props.get("data");
                    Property newProp = SwaggerConfigUtil.getNewProp(dataProp, SwaggerConfigUtil.getRealType(key), swagger.getDefinitions());
