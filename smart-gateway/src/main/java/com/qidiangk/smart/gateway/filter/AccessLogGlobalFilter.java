...
import com.qidiangk.smart.gateway.gateway.reactive.RecorderServerHttpRequestDecorator;
...
public class AccessLogGlobalFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        if (Fc.isNotBlank(exchange.getAttributeOrDefault(CachePostBodyFilter.CACHED_REQUEST_BODY,EMPTY))){
            builder.append("request body: ").append(NEWLINE);
            builder.append(TAB)
                    .append(exchange.getAttributeOrDefault(CachePostBodyFilter.CACHED_REQUEST_BODY,EMPTY))
                    .append(NEWLINE);
            exchange.getAttributes().remove(CachePostBodyFilter.CACHED_REQUEST_BODY);
        }
